...
@interface SamsungTVManager : NSObject
...
/**
 Thanks to http://forum.samygo.tv/viewtopic.php?f=12&t=1792 for the reverse engineering
 Possible remote keys are:
 KEY_MENU
 KEY_UP
 KEY_DOWN
 KEY_LEFT
